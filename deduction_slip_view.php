...
<html lang="en">
    ...
    <body style="padding-top: 10px;">
        <div class="container-fluid">
            ...
            <?php if((int) $lcaccrights === 4) :?>
                <div class="span2">
                    <div class="control-group">
                        <label for="cmbbranch" class="control-label" style="font-size: 11px;"><strong>Vendor Category</strong></label>
                        <div class="control-input">
                            <select style="width: 100% !important;" name="vndrcat" id="slcvencat">
            ...
            <?php endif; ?>
                ...
                <?php endif; ?>
                <!-- end ng date -->
                <div class="<?php echo ( ! $isReprint ) ? 'span5': 'span4'; ?>">
                    ...
                    <table class="table table-striped table-condensed">
                        ...
                        <tbody id="tblcontent">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;"><?php echo str_replace(':content', $rst->branch_code, $isCancelled); ?></td>
                                <td><?php echo str_replace(':content', $rst->remarks1.trim($rst->LBR_Number), $isCancelled); ?></td>
                                <td>
        ...
        <script type="text/x-handlebars-template" id="template-content">
            ...
            <tr>
                ...
                <td style="text-align: center;">{{branch_code}}</td>
                ...
                <td style="text-align: center;">{{branch_code}}</td>
                <td><span style="text-decoration: line-through;">{{remarks1}}</span></td>
                <td>
                ...
                <td>
                    ...
                    <span style="display: block;">{{reviewed}} {{lbrno}}</span>
                </td>
                {{/if}}
        ...
        <script type="text/javascript">
            ;(function(){
                ...
                $('#xfrdate, #cmdbranchid').on('change', function(e){
                    ...
                    var rs = $.post('deduction_slip_ajax_batch_on.php', { branch: $('select[name="cmbbranch"]').val(), odate: $('#xfrdate').val(), isconspo: isCons, vndrcat: $('#slcvencat').val() });
                ...
                $('#cmdreprint').on('click', function(){
                    window.location.href = "deductionslip.php?ispr=yes";
                });
