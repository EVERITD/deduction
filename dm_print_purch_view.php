...
<!--                             <label class="checkbox"><input type="checkbox" name="chkpage" id="chkidpage"> Print Page Cover Only</label> -->
                            ...
                            <a href="<?php echo 'deduction_slip_purch.php' ?>" class="btn btn-small"><strong>Back</strong></a>
    ...
    ?>
        ...
        <div class="container-fluid page-cover big-size <?php echo ( ! $pageCover ) ? 'no-display no-print': ''; ?>" id='page2' style="height: 850px;  margin-bottom: 85%; " >
