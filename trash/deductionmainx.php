...
$selqry = "select a.dm_no,a.branch_code,c.dept_code,d.division_code,e.category_name,f.subcat_name,suppliername,{$qrydate},
			a.amount,a.remarks,isnull(a.cancel_remarks,'') as cancel_remarks,a.encoded_by,a.vposted 
...
<body bgcolor="#5D7AAD">
	<form method="post" action="<?php echo $_SERVER['PHP_SELF']?>" name = "deductionmain">
	  <table width="100%" height="735" border="0">
        <tr>
          <td>
			  ...
			  <?php echo $selected?>><?php echo $b_row['category_name']?> </option>
				...
				<td width="130" rowspan="3"><input type="submit" name="cmdsearch" value=" Search "  title="Add Payment Order Slip" onClick="submit()"  style="width: 90%;height:40; background-color:#FF9933 " ></td>
				<td width="12">&nbsp;</td>
			  </tr>
			  <tr>
				<td>&nbsp;</td>
		...
		<tr>
          <td height="500" valign="top" bgcolor="#ffffff">
            ...
            <tr>
              ...
              <td colspan="2" width="4%" align="center" bgcolor="#99BBDD"><strong>Action</strong></td>
		    </tr>
			<?php 
			if ($nmrow > 0) {
				$r_select = mssql_query($selqry);
			...
			?>	
			  ...
			  <td width="4%" align="center">Edit</td>
			  		<?php if ($lcaccrights == 4 and $d_row['vposted'] == 1) {?>
			  ...
			  <td width="2%" align="center"><a href="dm_edit.php" onClick="javascript:window.open('dm_edit.php?dmno=<?php echo trim($d_row['dm_no'])?>&branch=<?php echo trim($d_row['branch_code'])?>','','scrollbars=no,resizable=no,width=400,height=420,left=200,top=95,dependent').focus();return false;" alt="Edit DM Deduction">View</a></td>
			  <?php }?>
            </tr>
		...
		<tr>
          <td>
		  	<table width="100%" height="4" border="0" bgcolor="#ffffff">
			<tr>
			  <td width="61%">
					<table width="100%" border="0" bgcolor="#ffffff">
						<tr>
