    ...
    <body style="padding-top: 10px;">
        <div class="container-fluid">
            <div class="row-fluid" style="border-bottom:solid 1px #ddd; padding-bottom: 10px; margin-bottom: 20px;">
                <div class="span12">
                    ...
                    <a href="<?php echo ( ! $isReprint ) ? 'deductionmain.php': 'deduction_slip_purch.php'; ?>" class="btn btn-small h-btn" style="float: right; margin-top: 5px;margin-right: 5px;"><strong>&larr; Back</strong></a>
                    <h4 style="padding-top: 10px;">DEDUCTION SLIP <?php echo ( ! $isReprint ) ? 'PRINTING': 'RE-PRINTING'; ?></h4>
                </div>
            </div>
            <form action="dm_print_purch_reprint.php?rprn=<?php echo $isReprint; ?>&prt=no" method="POST" id="frmload">
        ...
        <script type="text/x-handlebars-template" id="template-content">
            ...
            <tr>
                ...
                {{/if}}
                <td style="text-align: center;"><?php if($isReprint): ?><a href="dm_print_purch_reprint.php?ctrlno={{ctrlno}}&branch={{branch_code}}$need=no"><i class="icon-print"></i></a> <?php endif; ?></td>
            </tr>
            {{/each}}
        </script>
