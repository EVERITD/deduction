...
<!--                             <label class="checkbox"><input type="checkbox" name="chkpage" id="chkidpage"> Print Page Cover Only</label> -->
    ...
    ?>
        ...
        <div class="container-fluid page-cover big-size <?php echo ( ! $pageCover ) ? 'no-display no-print': ''; ?>" id='page2' style="height: 2000px;  margin-bottom: 85%; " >
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <table class="table table-striped table-bordered table-condensed" style="margin-top: 100px;">
                        <thead>
                            <tr>
                                <th width="14%">DS #</th>
                                <th width="8%">Vcode</th>
    ...
    <div class="small-size <?php echo ( $pageCover ) ? 'no-display no-print': ''; ?>" style="margin-left:0;padding-left:18px;width:305px;padding-bottom:68px;height:526px;padding-top:<?php echo $height; ?>px;">
