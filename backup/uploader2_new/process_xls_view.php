          ...
          <tbody>
            ...
            ?>
                  <tr>
                    ...
                    <td style="text-align: right;"><?php echo number_format($row['K'], 2); ?></td>
                    <td style="text-align: center;"><?php echo $row['L']; ?></td>
