                    ...
                    <table class="table table-striped table-bordered table-condensed" style="margin-top: 15px;">
                        <thead>
                            <tr>
                                ...
                                <th width="5%" style="text-align: center;">Sub Site</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo str_replace(':content', $mm->LBR_Number, $isCancelled); ?></td>
                                ...
                                <td style='text-align: center';><?php $brn = str_replace(':content', $mm->branch_code, $isCancelled); 
                                                                echo str_replace('S399', 'S306', $brn);
    ...
    <div class="small-size <?php echo ( $pageCover ) ? 'no-display no-print': ''; ?>" style="margin-left:0;padding-left:0;width:320px;<?php if($xc !== count($ctrlno)): ?> page-break-after: always; <?php endif; ?>height: 440px;">
        <table cellpadding="0" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="2" class="amt" style="text-align: left; vertical-align: top; border-top: none;border-bottom:none;padding-left: 43px; height: 93px;font-size: 12px;">
                        <?php echo trim($v->remarks1). (($v->LBR_Number) ? ' LBR#'.trim($v->LBR_Number) : ""); ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" style="padding-top: 50px;padding-left:10px;">
                        ...
                        <span style="display: block;">
                            <em style="margin-right: 20%;"><?php echo date('m/d/Y'); ?></em>
                            <?php if(isset($mainSitesList[trim($v->branch_code)]['code']) AND $mainSitesList[trim($v->branch_code)]['code'] !== $v->branch):
                               
                            endif;  echo '<em style="font-size: 10px;">Note: from '.str_replace('S399', 'S306', trim($v->branch_code)).'</em>';?>
                        </span>
                    </td>
                </tr>
            </tbody>
