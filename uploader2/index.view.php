        ...
        <div class="row-fluid">
            <div class="span12">
                <div class='btn-group pull-right'>
                    ...
                    <a class='btn' href="uploads/sss.xls"><i class="icon-download-alt"></i> Download Template</a>
        ...
        <div class="row-fluid">
            <div class="span12">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- <div class="control-group">
                        <label for="taremarks" class="control-label">Promo :</label>
                        <div class="controls">
                            <input name="taremarks" class="span6"></input>
                        </div>
                    </div> -->
